...
class AiControllerTest {
    ...
    void generateProofreadingShouldReturnFluxOfStrings() {
        ...
        doAnswer(invocation -> {
            ...
            return null;
        }).when(aiService).getProofreading(any(UniModalAiRequestDto.class), any());
    ...
    void ragSearchPostsShouldReturnPostList() throws Exception {
        ...
        CompletableFuture<PostIdListRagSearchDto> future = CompletableFuture.completedFuture(postIdsDto);
    ...
    void generateItineraryShouldReturnItinerary() throws Exception {
        ...
        CompletableFuture<AiPoweredItineraryResponseDto> future = CompletableFuture.completedFuture(responseDto);
        when(aiService.getAiPoweredItinerary(any(AiPoweredItineraryCreateRequestDto.class))).thenReturn(future);
