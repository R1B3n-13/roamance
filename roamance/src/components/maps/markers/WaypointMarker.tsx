...
export function WaypointMarker({
  ...
  // State to store the dynamically imported Leaflet module
  ...
  // Don't render the Marker until Leaflet is loaded
  if (!L) return null;
        ...
        >
          <div className="space-y-1 mb-3">
            <div className="flex items-center">
              <span
                className={cn(
                  'inline-flex items-center justify-center w-5 h-5 rounded-full text-xs font-medium mr-2',
                  isDarkMode
